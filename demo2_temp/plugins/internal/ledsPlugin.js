...
exports.start = function (params) {
  localParams = params;
  observe(model); //#A
  console.log("----localParams---" +  localParams.simulate);
...
function observe(what) {
  // Collect the information in a local variable
 console.log("----"); 
 console.log(what);
  var switchOn = what.value;

  Object.defineProperty(what, 'value', {
    ...
    set: function(changes) {
      console.log("switchOn status ----" + changes);
      switchOn = changes;
